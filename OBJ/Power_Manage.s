...
; 2 exit points
	.line	44, "Power_Manage.c"; 	if (Power_Onoff_FLAG)
	BANKSEL	_Sys_Flag0
	BTRSS	_Sys_Flag0,0
	MGOTO	_02036_DS_
	.line	46, "Power_Manage.c"; 	PCON1 = C_LVD_3P0V; // 配置比较器
	MOVIA	0x1c
	IOST	_PCON1
	.line	47, "Power_Manage.c"; 	Low_Voltage_Process();
	MCALL	_Low_Voltage_Process
_02036_DS_:
	.line	50, "Power_Manage.c"; 	if (Charging_FLAG)
	BANKSEL	_Sys_Flag1
	BTRSS	_Sys_Flag1,6
	MGOTO	_02039_DS_
	.line	52, "Power_Manage.c"; 	PCON1 = C_LVD_4P05V; // 配置比较器
	MOVIA	0x38
	IOST	_PCON1
...
_StandBy_Check:
; 2 exit points
	.line	29, "Power_Manage.c"; 	if (StandBy_FLAG && StandBy_ShutDown_Cnt >= StandBy_ShutDown_Time)
	BANKSEL	_Sys_Flag2
	BTRSS	_Sys_Flag2,5
	MGOTO	_02016_DS_
...
_02026_DS_:
	BTRSS	STATUS,0
	MGOTO	_02016_DS_
	.line	31, "Power_Manage.c"; 	StandBy_FLAG         = 0;
	BANKSEL	_Sys_Flag2
	BCR	_Sys_Flag2,5
	.line	32, "Power_Manage.c"; 	StandBy_ShutDown_Cnt = 0;
	BANKSEL	_StandBy_ShutDown_Cnt
	CLRR	_StandBy_ShutDown_Cnt
	CLRR	(_StandBy_ShutDown_Cnt + 1)
	.line	33, "Power_Manage.c"; 	Power_Off();
	MCALL	_Power_Off
_02016_DS_:
	.line	35, "Power_Manage.c"; 	}
	RETURN	
...
_StandBy_Mode:
; 2 exit points
	.line	19, "Power_Manage.c"; 	StandBy_FLAG      = 1;
	BANKSEL	_Sys_Flag2
	BSR	_Sys_Flag2,5
	.line	20, "Power_Manage.c"; 	M1_Work_FLAG      = 0;
	BANKSEL	_Sys_Flag1
	BCR	_Sys_Flag1,1
	.line	21, "Power_Manage.c"; 	M1_PWM_Write_FLAG = 0;
	BCR	_Sys_Flag1,2
	.line	22, "Power_Manage.c"; 	M1_Freq_Change    = 0;
	BANKSEL	_M1_Freq_Change
	CLRR	_M1_Freq_Change
	.line	23, "Power_Manage.c"; 	M1_Off;
	BANKSEL	_PORTA
	BCR	_PORTA,4
	.line	24, "Power_Manage.c"; 	TeleCon_M1_Work_Once_FLAG = 0;
	BANKSEL	_Sys_Flag4
	BCR	_Sys_Flag4,5
	.line	25, "Power_Manage.c"; 	}
	RETURN	
...
; 2 exit points
	...
	BANKSEL	_Sys_Flag4
	BCR	_Sys_Flag4,5
	.line	12, "Power_Manage.c"; 	RF_Control_Off;
	BANKSEL	_PORTA
	BSR	_PORTA,7
	.line	13, "Power_Manage.c"; 	M1_Off;
	BCR	_PORTA,4
	.line	14, "Power_Manage.c"; 	LED_Off;
	BSR	_PORTA,2
	.line	15, "Power_Manage.c"; 	}
	RETURN	
; exit point of _Power_Off


;	code size estimation:
;	   90+   30 =   120 instructions (  300 byte)
